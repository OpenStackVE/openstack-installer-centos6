...
#
# Script principal
# Versión 1.5.4 "BlackCat Reloaded"
...
"install")
	...
	echo "Versión 1.5.4 \"BlackCat Reloaded\" - Septiembre 03, 2013"
	echo ""
	echo "Se verificaran los prerequisitos"
	echo "Si alguno de los prerequisitos falla, se informará y se detendrá el proceso"
	echo ""
	echo "Prerequisitos:"
	echo "- OS: RHEL 6.4 en adelante (o compatible): SL 6.4, Centos 6.4, etc. de 64 bits"
	...
	echo "  * rdo:  http://repos.fedorapeople.org/repos/openstack/openstack-grizzly/epel-6/"
